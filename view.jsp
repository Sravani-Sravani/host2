       ...
       %> 
									...
									<div class="accordion accordion-flush" id="accordionFlushExample2017">
									  <div class="accordion-item">
										...
										<div id="collapseOne<%=i %>" class="accordion-collapse collapse" aria-labelledby="headingOne<%=i %>" data-bs-parent="#accordionFlushExample<%=i%>">
							...
							<div id="flush-collapseTransport" class="accordion-collapse collapse" aria-labelledby="flush-headingTransport" data-bs-parent="#accordionsubsectorlist">
							  <div class="accordion-body">
								<ul>
									...
									<li>Shipyards <i class="fa-solid fa-circle-exclamation" data-bs-toggle="tooltip" data-bs-placement="top" title="âShipyardâ is defined as a floating or land-based facility with the essential features of waterfront, turning basin, berthing and docking facility, slipways and/or ship lifts, and which is self sufficient for carrying on shipbuilding/repair/breaking activities."></i> </li>
									...
									<li>Logistics Infrastructure <i class="fa-solid fa-circle-exclamation" data-bs-toggle="tooltip" data-bs-placement="top" title="Logistics Infrastructureâ means and includes Multimodal Logistics Park comprising Inland Container Depot (ICD) with minimum investment of Rs 50 crore and minimum area of 10 acre, Cold Chain Facility
...
<li>Affordable Rental Housing Complex <i class="fa-solid fa-circle-exclamation" data-bs-toggle="tooltip" data-bs-placement="top" title="âAffordable Housingâ is defined as a housing project using at least 50% of the Floor Area Ratio (FAR)/Floor Space Index (FSI) for dwelling units with carpet area@ of not more than 60 square meters."></i> </li>
<li>Exhibition-cum-Convention Centre <i class="fa-solid fa-circle-exclamation" data-bs-toggle="tooltip" data-bs-placement="top" title="Affordable Rental Housing Complexâ means a project to be used for rental purpose only for urban migrant/poor (EWS/LIG categories) for a minimum period of 25 years with basic civic infrastructure
